package com.webshop.soa.inventory.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.webshop.soa.inventory.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.webshop.soa.inventory.security.DomainUserDetailsService", "createSpringSecurityUser");
