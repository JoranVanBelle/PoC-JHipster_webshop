...
import com.webshop.soa.transport.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.webshop.soa.transport.domain.Transport}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TransportResource {
    ...
    private static final String ENTITY_NAME = "transportTransport";
