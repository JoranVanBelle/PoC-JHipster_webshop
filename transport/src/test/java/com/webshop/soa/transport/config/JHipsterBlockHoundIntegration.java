package com.webshop.soa.transport.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.webshop.soa.transport.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.webshop.soa.transport.security.DomainUserDetailsService", "createSpringSecurityUser");
