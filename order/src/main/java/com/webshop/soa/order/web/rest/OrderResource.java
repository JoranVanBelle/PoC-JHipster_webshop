package com.webshop.soa.order.web.rest;

import com.webshop.soa.order.domain.Order;
import com.webshop.soa.order.repository.OrderRepository;
import com.webshop.soa.order.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.webshop.soa.order.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
                ...
                Mono<Order> result = orderRepository
                    ...
                    .map(existingOrder -> {
                        ...
                        if (order.getTransportID() != null) {
                            existingOrder.setTransportID(order.getTransportID());
                        }
