package com.webshop.soa.order.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.webshop.soa.order.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.webshop.soa.order.security.DomainUserDetailsService", "createSpringSecurityUser");
