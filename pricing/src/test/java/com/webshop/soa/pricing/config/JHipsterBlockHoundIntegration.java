package com.webshop.soa.pricing.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.webshop.soa.pricing.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.webshop.soa.pricing.security.DomainUserDetailsService", "createSpringSecurityUser");
